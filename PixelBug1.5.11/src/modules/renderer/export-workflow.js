(() => {
  ...
  function create(options) {
    ...
    function buildSpritesheet(profile = profileFromControls()) {
      ...
      const meta = { app: "Pixel Bug", version: "1.5.11", image: `${baseName}-sheet.png`, format: "RGBA8888", size: { w: sheet.width, h: sheet.height }, scale, clip: { name: clip.name, start: clip.start, end: clip.end, loop: clip.loop } };
