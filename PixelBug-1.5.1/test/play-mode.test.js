...
test("beginner play guide is connected", () => {
  ["play-guide-world", "play-guide-objects", "play-guide-rules", "play-guide-test", "play-prop-open-variable"].forEach(id => {
...
test("play review adds no package dependencies", () => {
  ...
  assert.doesNotMatch(renderer, /1\.5\.2/);
  assert.deepEqual(packageJson.dependencies || {}, {});
  assert.equal(packageJson.devDependencies.electron, "42.7.1");
