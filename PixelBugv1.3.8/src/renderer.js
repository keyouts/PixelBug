...
function newLayer(width, name = "Layer", height = width) { return { name, visible: true, opacity: 1, blendMode: "source-over", pixels: blankPixels(width, height), sourceWidth: width, sourceHeight: height, sourcePixels: blankPixels(width, height) }; }
