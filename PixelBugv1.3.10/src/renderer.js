...
function openSettingsModal() { settingsOverlay.hidden = false; renderShortcutSettings(); }
function closeSettingsModal() { settingsOverlay.hidden = true; listeningShortcut = null; }
...
window.addEventListener("keydown", e => {
  ...
  if (e.key === "Escape" && selectionBox && (pixelizerOverlay.hidden && voxelOverlay.hidden && customSizeOverlay.hidden && privacyOverlay.hidden && (!newProjectOverlay || newProjectOverlay.hidden) && (!settingsOverlay || settingsOverlay.hidden))) { e.preventDefault(); selectionAction("clear"); return; }
